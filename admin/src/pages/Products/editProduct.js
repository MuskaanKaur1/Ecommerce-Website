...
const EditProduct=()=>{
    ...
    useEffect(()=>{
         ...
         fetchDataFromApi(`/api/product/${id}`, formFields).then((res)=>{
            setProducts(res);
            setFormFields({
                name: res.name,
            ...
            //setIsProductRams(res.productRAMS);
            //setIsProductSize(res.productSIZE);
            //setIsProductWeight(res.productWEIGHT);
    ...
    return(
        ...
        <div className="right-content w-100 productUploadPage">
            <div className='card shadow border-0 w-100 p-4 res-col'>
                <h5 className='mb-0 color-white'>Edit Product</h5>

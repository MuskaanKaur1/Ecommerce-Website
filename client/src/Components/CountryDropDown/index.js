...
const filterList=(e)=>{
    ...
    return(
        <>
            ...
            <Dialog open={isOpenModel} onClose={()=>setisOpenModel(false)} className="locationDropDown">
                <h4>Choose Your Delivery Location</h4>
                <p>Enter your address and we will specify the offer to your area</p>
                <Button className="closeIcon" onClick={()=>setisOpenModel(false)}><IoMdClose/></Button>
